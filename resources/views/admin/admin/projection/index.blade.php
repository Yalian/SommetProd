...
@section('page_heading','Proyecciones')

@section('section')

    <div class="container">
        <div class="col-md-offset-9 col-md-2">
            <a id="new_projection" class="btn btn-success" href="{{route('proyecciones.create')}}"><span class="fa fa-plus"></span></a>
