<form method="post" id="editContractForm">
    ...
    <div class="modal-body">
        <div class="input-group">
            ...
            <input name="name" type="text" id="name" class="form-control" value="{{$projection->name}}">
        </div>
    </div>
    ...
    <div class="modal-body">
        <div class="input-group">
            ...
            <input name="address" type="text" id="address" class="form-control" value="{{$projection->address}}">
        </div>
    </div>
...
<script>
    $(function () {
        $('#save').on('click', function (e) {
            ...
            $.ajax({
                method: 'post',
                url: "{{route('proyecciones.update',['id'=> $projection->id])}}",
